...
class ModelDownloader {
  ...
  static const Map<String, String> modelUrls = {
    'braindler-q2_k': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-q2_k.gguf',
    'braindler-q3_k_s': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-q3_k_s.gguf',
    'braindler-q4_k_s': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-q4_k_s.gguf',
    'braindler-q5_k_m': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-q5_k_m.gguf',
    'braindler-q8_0': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-q8_0.gguf',
    'braindler-f16': 'https://huggingface.co/nativemind/braindler/resolve/main/braindler-f16.gguf',
  };
  ...
  static Future<String> downloadModel(
    ...
    if (!modelUrls.containsKey(modelName)) {
      throw ArgumentError('Unknown model: $modelName. Available models: ${modelUrls.keys.join(", ")}');
    }
  ...
  static Future<void> deleteModel(String modelName) async {
    final directory = await _getModelsDirectory();
    final fileName = modelName.endsWith('.gguf') ? modelName : '$modelName.gguf';
    final filePath = path.join(directory.path, fileName);
    final file = File(filePath);
